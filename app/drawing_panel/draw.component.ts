...
export class DrawComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ['#f00', '#ff0', '#0f0', '#0ff', '#00f', '#f0f', '#000', '#fff'].forEach(function(i, arr) {
      document.getElementById('colors_panel').insertAdjacentHTML('beforeend', "<a href='#colors_sketch' data-color='" + i + "' style='width: 15px;height: 15px;display: block;margin: 10px;background: " + i + ";'></a> ");
    });
